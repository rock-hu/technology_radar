...
Backed by services such as [Kubernetes](/platforms-and-services/kubernetes/), we can deploy Docker containers on a flexible infrastructure and enable our developers to test their software more easily in different environments.
